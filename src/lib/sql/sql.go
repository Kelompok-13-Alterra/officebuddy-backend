...
func Init(cfg Config) *gorm.DB {
	...
	if err := db.AutoMigrate(&entity.User{}, &entity.Office{}, &entity.Transaction{}, &entity.MidtransTransaction{}, &entity.Rating{}, &entity.ImageRating{}, &entity.Notification{}); err != nil {
		panic(err)
	}
